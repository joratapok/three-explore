...
void main()
{
    ...
    // не отражаем землю, отражаем воду
    float specularSurface = max(0.1, specularCloudsColor.r);
    specular = specular * specularSurface;

    // По краям берем цвет атмосферы а не белый
